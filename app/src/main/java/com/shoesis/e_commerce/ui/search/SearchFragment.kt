package com.shoesis.e_commerce.ui.search
...
import com.shoesis.e_commerce.databinding.FragmentSearchBinding
import com.shoesis.e_commerce.ui.adapter.ProductAdapter
import com.shoesis.e_commerce.ui.favorites.FavoritesViewModel
import com.shoesis.e_commerce.ui.newest.NewestViewModel
    ...
    private fun observer() {
        newestViewModel.newestList.observe(viewLifecycleOwner) { list ->
            binding.searchRv.let {
                ...
                productAdapter =
                    ProductAdapter(
                        list as MutableList<ProductDto>,
                        requireContext(),
                        layoutInflater,
                        favoritesViewModel
                    )
